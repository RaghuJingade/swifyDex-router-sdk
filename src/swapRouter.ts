...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from 'swifydex-sdk-core'
import { abi } from 'swifydex-swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from 'swifydex-v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
